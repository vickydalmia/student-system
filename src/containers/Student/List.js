...
import { checkfile, readUploadedFileAsText } from "../../utils/fileReader";
...
const StudentList = () => {
    ...
    const modifiedStudents = Array.isArray(students) && students.slice(0, pageStudent.page * 15)
    const lastRef = useScrollPage(
        false,
        false,
        pageDispatch
    );
                            ...
                            <TableBody>
                                {modifiedStudents.map((row, index) => (
                                    <TableRow key={index + 1}>
                                        ...
                                        <TableCell align="left">
                                            <button className="edit-button" onClick={() => editHandler(index + 1, row)}>Edit</button>
                                        </TableCell>
                                        <TableCell align="left">
